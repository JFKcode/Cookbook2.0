...
class CackeFragment : Fragment(R.layout.fragment_cacke) {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_cacke, container, false)
        ...
        btnSetTime.setOnClickListener {
            ...
            if (minutes != null && minutes > 0) {
                ...
                Log.d("Cacke_Fragment", "btnSetTime clicked: Starting countdown for $minutes minutes.")
            }
        }

        btnReset.setOnClickListener {
            mainViewModel.resetCountdown()
            Log.d("Cacke_Fragment", "btnReset clicked: Resetting countdown.")
        }

        mainViewModel.countdownTime.observe(viewLifecycleOwner, { remainingTime ->
            updateCountdownUI(remainingTime ?: 0)
            Log.d("Cacke_Fragment", "Countdown time updated: $remainingTime seconds remaining.")
        })
    ...
    private fun updateCountdownUI(remainingTime: Long) {
        ...
        Log.d("Cacke_Fragment", "Updating countdown UI: $formattedTime")
    }
}
