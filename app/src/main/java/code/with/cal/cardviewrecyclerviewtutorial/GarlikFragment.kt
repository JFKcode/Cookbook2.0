...
class GarlikFragment : Fragment(R.layout.fragment_garlik) {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_garlik, container, false)
        ...
        btnSetTime.setOnClickListener {
            ...
            if (minutes != null && minutes > 0) {
                ...
                Log.d("Garlik_Fragment", "btnSetTime clicked: Starting countdown for $minutes minutes.")
            }
        }

        btnReset.setOnClickListener {
            mainViewModel.resetCountdown()
            Log.d("Garlik_Fragment", "btnReset clicked: Resetting countdown.")
        }

        mainViewModel.countdownTime.observe(viewLifecycleOwner, { remainingTime ->
            updateCountdownUI(remainingTime ?: 0)
            Log.d("Garlik_Fragment", "Countdown time updated: $remainingTime seconds remaining.")
        })
    ...
    private fun updateCountdownUI(remainingTime: Long) {
        ...
        Log.d("Garlik_Fragment", "Updating countdown UI: $formattedTime")
    }
}
